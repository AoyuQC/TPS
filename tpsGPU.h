...
void ComputeTPSGPU(const float *p_valueI, // source frame
...
void K_star_KFunction(cv::gpu::PtrStepSzf dev_c_pos, int width, int height, int stride, int c_num, cv::gpu::PtrStepSzf dev_K_cc);
#endif
